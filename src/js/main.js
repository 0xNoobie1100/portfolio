...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        cat_help: "Output Information about project on screen",
        ...
        usage: "Usage",
        file: "file",
        file_not_found: "Project not found",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "Chaos_search":"\nDescription:\n\nthis is an enumeration program that enumerate domains and subdomains of a particular organization or multiple organizations from chaos by project discovery team and organize them in folders for user so that user can pipe the output to any other tool like eye witness to automatically take screenshots of the front page of those subdomains to examine.\n",
	"Instagram_autoposter":"\nDescription:\n\nthis is an automatic schedular which schedule instagram posts at fixed intervals throughout the day. Not only this the tool can also download random instagram posts based on set of 5 hashtags(it will scrap all other related hashtags) and then schedule the posts in a particular instagram account with random 25 hashtags in caption different from original post.",
	"Trafficker":"\nDescription:\n\nthis is a tool to improve SEO of a website and generate some revenue. it first take list of keywords in a text file and randomly searches them on google and visit a specific blog ranking for that keyword which is helpful for better ranking and for being undetectable it use proxies to tunnel the traffic before searching on google and for some revenue it clicks ad sometimes and someimes browse site for random time.",
	"Automatic_bidder":"\nDescription:\n\nthis is a pyhton script written for client which use selenium to automatically bid on auction site according to the configurations provided by the user in a config file.",
        "Contact": "\nHimanshuj426@gmail.com\nJoshi.97himanshu@protonmail.com\n",
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
...
var main = (function () {
    ...
    Terminal.prototype.handleSidenav = function (event) {
        if (this.sidenavOpen) {
            ...
            document.getElementById("sidenavBtn").innerHTML = "<div class=\"icon icon-red\"></div>\n<div class=\"icon icon-yellow\"></div>\n<div class=\"icon icon-green\">";
            this.sidenavOpen = false;
        } else {
